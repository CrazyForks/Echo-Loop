...
class _IntensiveListenSettingsSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SettingsSheetScaffold(
      title: l10n.intensiveListenSettings,
      subtitle: l10n.intensiveListenSettingsTemporaryHint,
      child: Column(
          ...
          if (!settings.isManualMode) ...[
            ...
            if (settings.repeatCount != 1)
              SwitchListTile(
                ...
                title: Text(
                  l10n.intensiveListenAnnotationReplayUsesRepeatCount,
                ),
                value: settings.annotationReplayUsesRepeatCount,
                onChanged: (value) {
                  ref
                      .read(intensiveListenPlayerProvider.notifier)
                      .updateSettings(
                        settings.copyWith(
                          annotationReplayUsesRepeatCount: value,
                        ),
                      );
                },
              ),
