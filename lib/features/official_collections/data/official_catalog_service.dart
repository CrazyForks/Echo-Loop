...
/// 普通刷新节流窗口（1 天）。force=true 可绕过。
const _kThrottleWindow = Duration(days: 1);
...
class OfficialCatalogService {
  ...
  Future<CatalogRefreshOutcome> _doRefresh() async {
    ...
    if (newHash == oldHash) {
      // 仅更新 meta.lastFetchedAt（让 1d 节流以上次发请求为基准）
